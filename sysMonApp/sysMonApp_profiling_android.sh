...
echo "(**) Starting sysMonApp Demo"

exho '(**) List adb devices:'
adb devices
export ANDROID_SERIAL="10.136.8.136:5555"
...
export sysMonApp_host_PATH="${HEXAGON_PATH}/tools/utils/sysmon/sysMonApp_64Bit"
...
export HOST_DLC_PATH="${HOME}/snpe-example/test_files/dlc/inception_v3_aip_quantized.dlc"
export DEVICE_DLC_PATH="/data/local/tmp/yolox_tiny_quant_hta.dlc"
export HOST_INPUT_RAW_PATH="${HOME}/snpe-example/test_files/data/chairs.raw"
export DEVICE_INPUT_RAW_PATH="/data/local/tmp/chairs.raw"

# Where SNPE Dir in host
export SNPE_DIR="${HOME}/Qualcomm/snpe-1.65.0.3676"
...
export TARGET_ADSP_LIBS="/system/lib/rfsa/adsp;/system/vendor/lib/rfsa/adsp;/vendor/dsp;/system/vendor/lib64;/vendor/lib/rfsa/adsp;/vendor/lib/rfsa/adsp/tests"
export TARGET_LD_LIBS="\${LD_LIBRARY_PATH}:/system/lib/rfsa/adsp:/system/vendor/lib/rfsa/adsp:/vendor/dsp:/system/vendor/lib64:/vendor/lib/rfsa/adsp:/vendor/lib/rfsa/adsp/tests"
...
function sysMonApp_cdsp_profiling() {
    ...
    export extra_profile_cdsp_args="--debugLevel 1 --profileFastrpcTimeline 1 --profileLPMLA --samplingPeriod 10 --duration 40"

    # sysMonApp Profiling
    adb shell "export ADSP_LIBRARY_PATH=\"${TARGET_ADSP_LIBS}\" && LD_LIBRARY_PATH=\"${TARGET_LD_LIBS}\" \\
        /data/sysMonApp tlp --profile 1 --q6 cdsp $extra_profile_cdsp_args"
    sleep 3
...
function sysMonApp_npu_profiling() {
    ...
    export extra_profile_npu_args="--samplingPeriod 10":
...
function sysMonApp_cdsp_npu_profiling() {
    ...
    export extra_profile_cdsp_npu_args="--profileFastrpcTimeline 1 --samplingPeriod 10"
